...
<Link to="/workerregister" className='rounded-md px-4 py-2 text-white bg-indigo-600 hover:bg-transparent hover:border-emerald-50 hover:text-white '>Join Now</Link>
</div>
</div>
    </div>
  )
