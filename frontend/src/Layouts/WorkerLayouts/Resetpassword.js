...
const findEmail=async()=>{
    const response=await axios.post(`${Baseurl}/api/workers/resetpassword`,{password:data.password,id:id})
...
if(datas){
  ...
  <section className="bg-gray-50 dark:bg-gray-900 ">
    ...
    <button class="bg-indigo-500 px-7 py-2 ml-2 rounded-md text-md text-white font-semibold" onClick={()=>navigate("/workerlogin")}>Ok</button>
  </div>
                </Modal> )}
